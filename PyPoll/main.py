...
with open('ElectionResults.csv', 'w', newline='') as ER:  
    ...
    csvwriter.writerow([(f"Election Results Just In From All Precints with {totalvotes} Votes Cast!")])
    csvwriter.writerow([("---------------------------------------------")])
    csvwriter.writerow([(f"Khan received {K} votes. This was {Khanpercent} percent of all votes cast.")])
    csvwriter.writerow([(f"Correy received {C} votes.This was {Correypercent} percent of all votes cast.")])
    csvwriter.writerow([(f"Li received {L} votes.This was {Lipercent} percent of all votes cast.")])
    csvwriter.writerow([(f"O'Tooley received {O} votes. This was {OTooleypercent} percent of all votes cast.")])
    csvwriter.writerow([("---------------------------------------------")])
    csvwriter.writerow([(f"The Official-elect: {final[0]} with {final[1]} percent of the vote.")])
